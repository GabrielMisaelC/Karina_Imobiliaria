...
if ($inq == null) {
	...
	if ($total){
		do{
			...
			$cpf = $linha["CPF_INQ"];
			$data_nascimento = $linha["DATA_NASCIMENTO_INQ"];
			$rg = $linha["RG_INQ"];
			$endereco_atual = $linha["ENDERECO_ATUAL_INQ"];
			$status_civil = $linha["ESTADO_CIVIL_INQ"];
			$rne = $linha["REN_INQ"];
			$profissao = $linha["PROFISSAO_INQ"];
			$condicao = $linha["CONDICAO_PAGAMANTO_INQ"];
		}
...
<body>
	<center>
    <form action="inquilino.php" method="post">
	<fieldset>
	<legend>Ficha De Inquilino</legend>
	<p>
<label>
	<span>Nome:</span>
	<br>
